			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					...
					<div class="pull-right">
						<a href="/"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="/services">Our services</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="/road-trucking">Road trucking</a>
					</div>
				</div>
			</div>
...
<?php include 'services_sidebar.php' ?>
					...
					<div class="col-sm-9 main-content">
						...
						<div class="row">                    	
							...
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <h4>What we offer</h4>
                                <p>UBUNTU CLEARING & FORWARDING LIMITED provides a reasonable yet comprehensive transportation network within East Africa and will be in a position to handle the following:</p>
								<ul class="fa-ul">
                            <li>
