			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					...
					<div class="pull-right">
						<a href="/"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="/services">Our services</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="/air-freight">Air freight</a>
					</div>
				</div>
			</div>
					...
					<div class="col-sm-9 main-content">
						...
						<div class="row">                    	
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <p>Air Freight as a means of ferrying goods has its timely and security advantages and is the best when distance plays a challenge. UBUNTU CLEARING & FORWARDING LIMITED using its network with airlines, we are able to offer international coverage on air freight to and from whichever part of the world and also assist in interconnections of flights schedules for Transit Cargo. 
								</p>
							...
							<div class="col-xs-6 wow zoomIn" data-wow-delay="0.3s">
                                <h4>What we offer</h4>
                                <p>UBUNTU CLEARING & FORWARDING LIMITED Ltd. can organize scheduled flights and chartered planes from a wide range of major carriers making us flexible enough to help everyone from first-time shippers to regular importers and exporters of freight.</p>
								<ul class="fa-ul">
                                    <li>
